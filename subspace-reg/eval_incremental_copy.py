...
from eval.language_eval_copy import few_shot_finetune_incremental_test
...
def main():
    ...
    if opt.dataset == 'cub200':
        ...
        # training.
        base_test_loader = DataLoader(cub200(args=opt, base_sess = True, train = False, transform=train_trans,index = 100, index_path = 1),
                                  batch_size=64, shuffle=True, drop_last=True,
                                  num_workers=opt.num_workers)

        meta_valloader = DataLoader(cub200(args=opt, base_sess = False, train=False, transform=test_trans,index = 100, index_path = 1),
