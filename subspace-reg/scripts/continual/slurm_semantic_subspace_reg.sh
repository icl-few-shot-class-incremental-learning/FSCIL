...
BACKBONE_FOLDER="${DUMPED_PATH}/cubtest/backbones/continual/efficientb0"
mkdir -p $EXP_FOLDER
...
BACKBONE_PATH="${DUMPED_PATH}/cubtest/backbones/continual/efficientb0/pretrained0.05/ckpt_epoch_150.pth"
python eval_incremental_copy_pretrained.py --model_path $BACKBONE_PATH \
                        ...
                        --memory_replay 0 > $LOG_STDOUT 2> $LOG_STDERR
