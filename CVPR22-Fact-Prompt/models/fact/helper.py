...
def base_train(model, trainloader, optimizer, scheduler, epoch, args,mask):
    ...
    for i, batch in enumerate(tqdm_gen, 1):
        ...
        logits, res_prompt = model(data)
        # print(res_prompt)
        # print(res_prompt['selected_key'].shape)
        # print(res_prompt['sim'].shape)
        # print(logits)
        # print(logits.shape)
        ...
        sur_loss = (res_prompt["reduce_sim"][0]+res_prompt["reduce_sim"][1])/2
...
def replace_base_fc(trainset, transform, model, args):
    ...
    # print(model.module.fc.weight.data.shape)
    # ss
